...
#[test]
fn test_simple() {
    run_and_compare_with_cat(&["tests/fixtures/256.txt"]);
}

#[test]
fn test_show_all() {
    run_and_compare_with_cat(&["tests/fixtures/256.txt", "-A"]);
}

#[test]
fn test_line_number() {
    run_and_compare_with_cat(&["tests/fixtures/256.txt", "-n"]);
}

#[test]
fn test_number_nonblank() {
    run_and_compare_with_cat(&["tests/fixtures/256.txt", "-n", "-b"]);
}

#[test]
fn test_nonprinting() {
    run_and_compare_with_cat(&["tests/fixtures/256.txt", "-t"]);
}

#[test]
fn test_nonprinting_ends() {
    run_and_compare_with_cat(&["tests/fixtures/256.txt", "-e"]);
}

#[test]
fn test_squeeze_blank() {
    run_and_compare_with_cat(&["tests/fixtures/256.txt", "-s"]);
}
...
fn test_show_nonprintable() {
    run_and_compare_with_cat(&["tests/fixtures/256.txt", "-v"]);
}
